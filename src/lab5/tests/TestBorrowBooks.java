...
class TestBorrowBooks {
	...
	void borrowBookBook() {
		...
		assertTrue(book1.getIsAvailable(), "PaperBook 1 must be available");
		member1.borrowBook(book1);
		assertFalse(book1.getIsAvailable(),"PaperBook 1 must be not available");
		assertEquals(member1.borrowedBooksCount(),1, "Count of borrowed books must be 1");
		
		// borrow second book
		assertTrue(book2.getIsAvailable(),"PaperBook must be available");
		member1.borrowBook(book2);
		assertFalse(book1.getIsAvailable(), "PaperBook should not be available");
	...
	void returnBookBook() {
		...
		// borrow two books
		assertTrue(book1.getIsAvailable(), "PaperBook 1 should be available");
		assertTrue(book2.getIsAvailable(), "PaperBook 2 should be available");
		...
		assertFalse(book1.getIsAvailable(), "PaperBook 1 should not be available");
		assertFalse(book2.getIsAvailable(), "PaperBook 2 should not be available");
		...
		assertTrue(book2.getIsAvailable(), "PaperBook should be available after return");
